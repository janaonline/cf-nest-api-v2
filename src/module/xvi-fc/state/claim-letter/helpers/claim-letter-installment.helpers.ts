...
/**
 * V1 supports Installment 1 only — Installment 2 stays schema-legal but is rejected here as a
 * simple guard, not dead branching logic elsewhere in the module.
 */
